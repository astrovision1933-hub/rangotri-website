...
const config = {
  ...
  // ---------- BRAND COLORS ----------
  colors: {
    indigo: "#1B3350",   // primary dark color (header, footer, buttons)
    cream: "#EFE7D8",    // page background
    rust: "#C1622D",     // accent color (buttons, highlights)
    charcoal: "#24211D", // main text color
    card: "#FBF7EE",     // card backgrounds
  },
