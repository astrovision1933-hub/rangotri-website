...
const emptyConfig = {
  ...
  colors: { indigo: "#1B3350", cream: "#EFE7D8", rust: "#C1622D", charcoal: "#24211D", card: "#FBF7EE" },
      ...
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 10, marginBottom: 14 }}>
          {Object.entries(config.colors).map(([key, val]) => (
            <div key={key}>
              <label style={{ display: "block", fontSize: 11.5, fontWeight: 600, color: "#1B3350", marginBottom: 4, textTransform: "capitalize" }}>{key}</label>
